...
// **Before (Slow - repeated calculations):**
// ```
// Order with 2 origins:
// 1. Process items for RLX (5 seconds)
// 2. Call FedEx API for RLX (2 seconds)
// 3. Process items for ARC_AZ (5 seconds) ❌ DUPLICATE WORK
// 4. Call FedEx API for ARC_AZ (2 seconds)
// Total: ~14 seconds
// ```

// **After (Fast - calculate once):**
// ```
// Order with 2 origins:
// 1. Process items for ALL origins ONCE (6 seconds)
// 2. Call FedEx API for RLX (2 seconds) ⚡ PARALLEL
// 3. Call FedEx API for ARC_AZ (2 seconds) ⚡ PARALLEL
// Total: ~8 seconds
